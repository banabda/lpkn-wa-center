        ...
        <div class="relative min-h-screen flex ">
            <div
                ...
                <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
                    ...
                    <div class="absolute bg-gradient-to-b bg-pink-002 to-blue-500 opacity-75 inset-0 z-0"></div>
                ...
                <div  class="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
                    <div class="max-w-md w-full space-y-8">
                        ...
                        <form class="mt-8 space-y-6" method="POST" action="{{ route('login') }}">
                            ...
                            <div>
                                <button type="submit"
                                    class="w-full flex justify-center bg-gradient-to-r bg-pink-001 bg-pink-001  hover:from-pink-500 hover:from-pink-500 hover:from-pink-500 text-gray-100 p-4  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                                    {{ __('Masuk') }}
                                </button>
                            </div>
